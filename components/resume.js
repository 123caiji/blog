(function () {
    ...
    function renderContact(c) {
        ...
        if (c.email) {
            ...
            parts.push(`<a class="resume-contact-a" href="mailto:${escapeHtml(c.email)}">${escapeHtml(c.email)}</a>`);
    ...
    function renderExperience(list) {
        ...
        const blocks = list
            ...
            .map((job) => {
                ...
                const loc = job.location ? ` <span class="resume-entry-loc">${escapeHtml(job.location)}</span>` : "";
